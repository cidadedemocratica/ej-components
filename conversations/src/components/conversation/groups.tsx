...
export class EjConversationInfos {
  ...
  @Prop() clustersIsReady: boolean = false;
  ...
  showClusters() {
    let loading: HTMLElement = this.el.shadowRoot.querySelector(
      ".groups-loading"
    );
    ...
    return (
      <div>
        <div class="box">
          ...
          {this.clustersIsReady &&
            this.conversation.statistics.votes.total >=
              this.minimalVotesGroups && (
              <div class="clusters">
                <nav>
                    ...
                    this.clusters.map((cluster: any, index: number) =>
                      index == 0 ? (
                        <div
                          ...
                          onClick={this.showClusterData.bind(
                            this,
                            cluster.name
                          )}
                        >
                ...
                <span class="clusters-message">
                  Comentários típicos do grupo{" "}
                  <b>{this.selectedCluster.name}</b>
                </span>
                <div class="details">
                    ...
                    <div>
                      ...
                      <div class="comments-box">
                        <div class="positive">
                          ...
                          {this.selectedCluster.positive_comments.length ==
                            0 && (
                      ...
                      <div>
                        <div
                          ...
                          class="comments-label"
                        >
                          {this.selectedCluster.negative_comments.length >
                            0 && (
                            <i
                              class={`fa fa-plus add-comment-${this.theme}`}
                            ></i>
                          )}
                          <span class={`add-comment-${this.theme}`}>
                              ...
                              this.selectedCluster.negative_comments.map(
                                (comment: any) => (
                                  <div class="cluster-comment">
                                    <div class="comment-ratio">
                                      {(
                                        parseFloat(Object.keys(comment)[0]) *
                                        100
                                      ).toFixed(1)}{" "}
                                      %
                                    </div>
          ...
          {this.conversation.statistics.votes.total <
            ...
            <div class="no-groups">
              ...
              votos superior a <b>{this.minimalVotesGroups}</b>. O número atual
              de votos computados é{" "}
